"""
Script Training Machine Learning untuk EA XAUUSD v2.14 (Fase 2)
Memproses dataset fitur -> Melatih XGBoost Classifier -> Mengekspor ke model ONNX

Changelog:
- v2.14: Upgrade 19 Fitur Konteks Pasar + XGBoost + threshold tuning + walk-forward CV
"""
...
def train_and_export(df: pd.DataFrame, output_onnx: str = "model_xau.onnx"):
    ...
    print(f"\n=== EVALUASI MODEL (threshold={best_thr:.3f} - OPTIMAL) ===")
